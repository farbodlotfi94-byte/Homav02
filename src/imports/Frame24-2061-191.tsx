import svgPaths from "./svg-wv3md74e8q";
...
function Frame3() {
  return (
    <div className="absolute bg-[rgba(16,24,40,0.05)] box-border content-stretch flex items-center justify-between left-1/2 pl-[64px] pr-0 py-0 rounded-[24px] top-[685px] translate-x-[-50%] w-[336px]">
      <p className="font-['Vazirmatn:SemiBold',_sans-serif] font-semibold leading-[24px] relative shrink-0 text-[#00312d] text-[16px] text-nowrap text-right whitespace-pre" dir="auto">
        نظر بده!
      </p>
      <Frame />
    </div>
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex font-['Vazirmatn:Black',_sans-serif] font-black gap-[256px] items-center leading-[normal] right-[124px] text-[64px] text-center text-nowrap top-[352px] whitespace-pre">
      <p className="opacity-0 relative shrink-0 text-[#5d0d02]" dir="auto">
        بد
      </p>
      <p className="opacity-0 relative shrink-0 text-[#fc6f20]" dir="auto">
        معمولی
      </p>
