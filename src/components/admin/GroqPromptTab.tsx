/**
 * GroqPromptTab Component
 * Manages Groq AI prompt enhancement configuration with textarea editor
 */
...
export function GroqPromptTab() {
  ...
  const loadCurrentPrompt = async () => {
    ...
    try {
      const response = await adminService.getGroqPrompt();
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await adminService.updateGroqPrompt(formState.prompt);
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900">تنظیمات Groq Prompt</h3>
        </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600">
            مدیریت prompt برای بهبود و تحلیل تصاویر با Groq AI
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Label className="text-sm font-medium text-gray-700">
              Groq Prompt Enhancement Template
            </Label>
      ...
      <Card className="p-4 bg-blue-50 border-blue-200">
        <div className="text-sm text-blue-800">
          ...
          <ul className="space-y-1 list-disc list-inside">
            <li>Prompt شما برای تحلیل و بهبود prompt‌های Gemini استفاده می‌شود</li>
            <li>Groq به عنوان مرحله اول پردازش، تصاویر را تحلیل می‌کند</li>
            <li>تغییرات فوری اعمال می‌شوند و روی پردازش‌های جدید تأثیر می‌گذارند</li>
            <li>برای بهترین نتیجه، دستورالعمل‌های واضح برای تحلیل تصویر بنویسید</li>
          </ul>
        </div>
      </Card>
    </div>
